...
describe('Component c-input', () => {
    it('should render the input without props', () => {
        ...
        assert.strictEqual(html, '<c-input><div class="field"><input value="" type="text"></div></c-input>')
    })
    ...
    it('should render the input with a default value', () => {
        ...
        const _html = render('c-input', cInput, { value: "Firstname", outlined: true})
    ...
    it('should render multiple props: label, type, error and round', () => {
        ...
        const _html = render('c-input', cInput, { label: "Password", outlined: true, type: "password", error: "The password is too show, minimum 20 characters.", round: true})
